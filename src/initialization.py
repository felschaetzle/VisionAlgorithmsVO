...
import numpy as np
import os
from key_point_tracker.shi_tomasi import shi_tomasi
from key_point_tracker.harris import harris
from key_point_tracker.selectKeypoints import selectKeypoints
from key_point_tracker.describeKeypoints import describeKeypoints
from key_point_tracker.matchDescriptors import matchDescriptors
from key_point_tracker.plotMatches import plotMatches

from eight_point.estimate_essential_matrix import estimateEssentialMatrix
from eight_point.decompose_essential_matrix import decomposeEssentialMatrix
from eight_point.disambiguate_relative_pose import disambiguateRelativePose
from eight_point.linear_triangulation import linearTriangulation
from eight_point.draw_camera import drawCamera
...
def bootstrap(K):
    img_1 = np.array(cv2.imread("../data/kitti/05/image_0/000000.png"))
    img_2 = np.array(cv2.imread("../data/kitti/05/image_0/000002.png"))
...
if __name__ == "__main__":
    print(os.getcwd())
    initialization(np.array([[7.188560000000e+02, 0, 6.071928000000e+02],
                    [0, 7.188560000000e+02, 1.852157000000e+02],
                    [0, 0, 1]]))
    bootstrap(np.array([[7.188560000000e+02, 0, 6.071928000000e+02],
                    [0, 7.188560000000e+02, 1.852157000000e+02],
                    [0, 0, 1]]))