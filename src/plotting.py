...
class Plotter:
    ...
    def live_plotter(self,num,image,q_initial,q_current,x_vec,y_vec,line1,identifier='',pause_time=0.3):
        if line1==[]:
            ...
            plt.tight_layout()
            plt.show()
            # print("Click 1 times onto the screen to preceed...")
        ...
        self.plot1.imshow(image,cmap="gray")
